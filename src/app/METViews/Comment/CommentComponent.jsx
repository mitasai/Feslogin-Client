...
import {
  ...
  deleteComment
} from "../manageEvent/EventComment";
import {
  addNew,
  getListEmotionUser,
  deleteEmotion,
} from "../manageEvent/EmotionUserService";
import { isAdmin, isHost, isUser} from "app/auth/authRoles";
import PopupComfirmDelete from "./PopupComfirmDelete";
...
class CommentComponent extends React.Component {
  ...
  replyComment = (id, index, user, quantity) => {
    console.log("quantity: " + quantity + ", " + this.state.isHidden);
    console.log("pageSizeChild: "+this.state.pageSizeChild);
    let { enableDisableAllLoading } = this.props;
    enableDisableAllLoading(true);
    var searchObject = {};
    searchObject.pageIndex = 1;
